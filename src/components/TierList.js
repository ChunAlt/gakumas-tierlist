...
class TierList extends React.Component {
    ...
    render() {
        ...
        const resultsTable = [
            ...
            [resultValues[0].startingMult[0], resultValues[0].startingMult[1], resultValues[0].startingMult[2], Math.round((resultValues[0].startingMult[0] + resultValues[0].startingMult[1] + resultValues[0].startingMult[2])*10)/10],
            ...
            <div className="weights" key={resultValues[0].finalScore[0]}>
                ...
                </div>
                {
                    ...
                    <>
                        ...
                        <div>
                            Estimated exam score needed for each grade: SS+: {examReq[0]}, SS: {examReq[1]}, S+: {examReq[2]}, S: {examReq[3]}, A+: {examReq[4]}               
                        </div>
                        <br />
                    </>
                }
