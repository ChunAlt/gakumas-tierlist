                ...
                </div>
                {
                    ...
                    <>
                        ...
                        <div className="weight-row">
                            ...
                            <NumericInput onChange={this.onGeneralSettingChanged} type="number" id="spRate.0" value={this.state.general.spRate[0]} min={0} max={25} step={5} />%
                            <label for="spRate.1">Dance</label>
                            <NumericInput onChange={this.onGeneralSettingChanged} type="number" id="spRate.1" value={this.state.general.spRate[1]} min={0} max={25} step={5} />%
                            <label for="spRate.2">Visual</label>
                            <NumericInput onChange={this.onGeneralSettingChanged} type="number" id="spRate.2" value={this.state.general.spRate[2]} min={0} max={25} step={5} />%
                        </div>
                        <br />
                        <div className="weight-row">
                            <div className="section-header">
                        ...
                        <div className="weight-row">
                            ...
                            <div className="section-explanation">
                                ...
                                Oikomi Lessons stat gain: <b>90+90</b> and <b>165+145</b>
                            </div>
                            <div className="section-subheader">
                                Vocal Lessons
                            </div>
